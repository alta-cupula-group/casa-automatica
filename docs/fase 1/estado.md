...
| `M1.7-lint` | M1 · CI | dividida | `em exploração` | `M1.4` | 2026-09-21, ordem emitida. Objetivo ampliado pelo operador na mesma data, e unidade renomeada de `M1.7-oxlint`. Explorador a definir pelo operador |
