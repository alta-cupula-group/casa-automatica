...
| `M1.7-lint` | M1 · CI | dividida | `contrato em rascunho` | `M1.4` | 2026-09-22, exploração entregue por Claude Code, com uma rodada de devolução do condutor. O operador escolheu a opção A, só o oxlint, com G1, G2 e G3, na mesma data. Condutor escreve o contrato |
