...
| 10 | Ambientes Supabase criados | **resolvida.** Em 2026-09-16 o operador criou as duas organizações e os dois projetos, com a Data API desligada. O `prod` foi recriado em São Paulo depois que o condutor apontou a latência da região do Canadá. Nomes e regiões em `docs/scope-brief.md`, seção 4. Falta só adicionar os outros moradores como Developer, o que não trava nenhuma unidade |
