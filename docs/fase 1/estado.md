...
| `M1.2-ambientes-e-migracoes` | M1 · Banco | dividida | `aguardando operador` | `M0.1`, `M1.1` | 2026-09-21, contrato aprovado pelo condutor e levado ao GATE 1, com a P1 sobre verificação do certificado. Exploração entregue e veredito do operador sobre PO1 a PO5 na mesma data |
