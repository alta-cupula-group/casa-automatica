...
| `M1.7-lint` | M1 · CI | dividida | `aguardando operador` | `M1.4` | 2026-09-22, contrato escrito e aprovado pelo condutor. Opção A, só o oxlint, com G1, G2 e G3, por decisão do operador na mesma data |
