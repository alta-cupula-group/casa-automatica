...
| `M1.7-lint` | M1 · CI | dividida | `aprovada` | `M1.4` | 2026-09-22, GATE 1 vencido. Opção A, só o oxlint, com G1, G2 e G3. Revisão com revisor separado, em sessão própria, por decisão do operador |
