...
- **Onde o Docker roda:** num guest próprio do Proxmox, nunca no host. Nenhuma aplicação da casa roda no hipervisor. Em 16/09/2026 existe o guest `casa-automatica` com 2 vCPU, 4 GB de RAM e 25 GB de disco, rodando Debian 13, Docker 29.8.1 e Compose v5.5.1. O operador avalia trocar o container LXC por uma máquina virtual. A forma final do guest sai da unidade `M1.5-compose-e-caddy`.
